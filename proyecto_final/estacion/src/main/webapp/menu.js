        ...
        .then(data => {
            ...
            sidebar.innerHTML = `
                ...
                <ul>
                    ...
                    <li><a href="${serverPath}/cliente_e.html" class="menu-link">Datos de sensores</a></li>
                    <li><a href="${serverPath}/configura_variable.html" class="menu-link">Configuración</a></li>
